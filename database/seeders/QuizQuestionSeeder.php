        ...
        if ($mathQuizId) {
            $questions = array_merge($questions, [
                ...
                [
                    ...
                    'media_path' => null,
                    'explanation' => null,
                    'explanation' => 'Rumus luas segitiga adalah 1/2 × alas × tinggi.',
                    'time_limit' => 20,
                    'points' => 100,
                    'order' => 3,
                    'created_at' => now(),
        ...
        if ($scienceQuizId) {
            $questions = array_merge($questions, [
                ...
                [
                    ...
                    'media_path' => null,
                    'explanation' => null,
                    'explanation' => 'Rumus kimia air adalah H2O, yang berarti dua atom Hidrogen dan satu atom Oksigen.',
                    'time_limit' => 25,
                    'points' => 100,
                    'order' => 3,
                    'created_at' => now(),
        ...
        if ($englishQuizId) {
            $questions = array_merge($questions, [
                ...
                [
                    ...
                    'media_path' => null,
                    'explanation' => null,
                    'explanation' => 'Kalimat yang benar adalah "She doesn\'t like pizza".',
                    'time_limit' => 30,
                    'points' => 150,
                    'order' => 3,
                    'created_at' => now(),
