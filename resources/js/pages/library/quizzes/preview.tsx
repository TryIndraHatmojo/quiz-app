...
export default function QuizPreview({ quiz, canManageQuestions }: Props) {
            ...
            >
                ...
                <div className="rounded-2xl bg-white p-12 text-center shadow-2xl">
                    ...
                    <p className="mb-6 text-muted-foreground">
                        Tambahkan pertanyaan terlebih dahulu
                    </p>
                    {canManageQuestions && (
                        <Button asChild>
                            <Link
            ...
            <div className="rounded-2xl bg-white p-8 shadow-xl">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                        Setiap soal hanya bisa dipasangkan dengan satu jawaban,
                        dan setiap jawaban hanya bisa digunakan sekali
                    </p>
                </div>
                <div
                    ref={setContainerRef}
